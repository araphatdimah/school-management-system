					...
					<div class="tab-main">
						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								<h2 class="inner-tittle"><?php 
								$timeNow = date("h");
								$timeState = date("a");
								if($timeNow > 4 && $timeState =="pm")
								{
									echo "Good evening, ", $info_display['t_fullname'];	
								}elseif($timeNow >= 0 && $timeNow <= 4 && $timeState == "pm")
								{
									echo "Good afternoon, ", $info_display['t_fullname'];	
								}
								elseif($timeNow >=0 && $timeNow <= 11 && $timeState == "am")
								{
									echo "Good morning, ", $info_display['t_fullname'];
								}
								 ?>  </h2>
								<div class="graph">
									<nav>
